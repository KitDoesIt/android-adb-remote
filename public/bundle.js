var s={zh:{appTitle:"\uD83D\uDCFA TV Remote",statusConnected:"已连接",statusDisconnected:"未连接",statusReconnecting:"重连中…",statusChecking:"连接中…",statusAuth:"等待授权",statusError:"错误",statusNoDevice:"未设置设备",statusTapReconnect:"点击重连",statusTapRetry:"点击重试 — 在 TV 上确认",statusTapCheck:"点击检查",authHint1:"⚠️ 等待 TV 授权。请在电视上确认调试授权弹窗。",authHint2:"如未弹出，请在 TV 设置中：撤销 USB 调试授权，然后关闭再重开 ADB 调试。",authForceBtn:"强制重新认证",authApproving:"正在 TV 上确认…",actionBack:"返回",actionHome:"主页",actionMenu:"菜单",quickLaunch:"快捷启动应用",addApp:"添加应用",textInput:"文本输入",textModalTitle:"在 TV 上输入",textPlaceholder:"输入要发送的文本…",clear:"清空",cancel:"取消",send:"发送",pickerTitle:"选择应用",searchPlaceholder:"\uD83D\uDD0D 搜索应用…",noAppsFound:"未找到应用",settingsTitle:"设置",settingMenuFix:"菜单键修复",settingMenuFixDesc:"若菜单键单击不灵敏（需要双击）可开启",settingDpadRepeat:"方向键长按重复",settingDpadRepeatDesc:"长按上下左右时自动连续触发",settingSimLongPress:"模拟长按（操作更稳定）",settingSimLongPressDesc:"短按=普通按下，长按=长按事件；不发送分离的按下/抬起",vibration:"振动反馈",vibStrength:"振动强度",vibStrengthDesc:"基础时长（毫秒），档位越高越强",vibAvailable:"✓ 支持振动（按一次按键后刷新查看结果）",vibWorking:"✓ 振动正常工作",vibBlocked:"✗ 系统拒绝了振动 — 请检查系统设置 → 触摸振动/免打扰",vibUnavailable:"✗ 此设备/浏览器不支持振动（iOS Safari 不支持）",close:"关闭",editTitle:"编辑应用",editName:"应用名称",editUpload:"上传图标",editDelete:"删除",editSave:"保存",editCancel:"取消",toastAdded:"已添加",toastRemoved:"已移除",toastLaunching:"启动中",toastClearing:"清空中…",toastCleared:"已清空",toastSent:"已发送",toastSaved:"已保存",toastConnecting:"连接中…",toastConnected:"✓ 已连接",toastFailed:"✗ 失败",toastForceReconnect:"强制重连中… 请查看 TV",toastApproveOnTv:"\uD83D\uDD10 请查看 TV 屏幕",toastSentFail:"✗ 发送失败",toastLaunchFail:"✗ 启动失败",titleTapLaunch:"点击启动 · 长按移除",volUp:"音量+",volDown:"音量-",prev:"上一个",next:"下一个",rewind:"快退",fastForward:"快进",playPause:"播放/暂停",mute:"静音",up:"上",down:"下",left:"左",right:"右",ok:"确定"},en:{appTitle:"\uD83D\uDCFA TV Remote",statusConnected:"Connected",statusDisconnected:"Disconnected",statusReconnecting:"Reconnecting…",statusChecking:"Connecting…",statusAuth:"Waiting for approval",statusError:"Error",statusNoDevice:"No device",statusTapReconnect:"Tap to reconnect",statusTapRetry:"Tap to retry — approve on TV",statusTapCheck:"Tap to check",authHint1:"⚠️ Waiting for TV approval. Check the debug authorization dialog on your TV.",authHint2:"If it doesn't appear: revoke USB debugging authorizations, then toggle ADB debugging off/on.",authForceBtn:"Force Re-authenticate",authApproving:"Approve on TV…",actionBack:"Back",actionHome:"Home",actionMenu:"Menu",quickLaunch:"Quick Launch",addApp:"Add App",textInput:"Text Input",textModalTitle:"Type on TV",textPlaceholder:"Enter text to send…",clear:"Clear",cancel:"Cancel",send:"Send",pickerTitle:"Select App",searchPlaceholder:"\uD83D\uDD0D Search apps…",noAppsFound:"No apps found",settingsTitle:"Settings",settingMenuFix:"Menu Key Fix",settingMenuFixDesc:"Enable if the menu key needs a double-tap to respond",settingDpadRepeat:"D-pad Key Repeat",settingDpadRepeatDesc:"Auto-repeat when holding up/down/left/right",settingSimLongPress:"Simulated Long-press (more stable)",settingSimLongPressDesc:"Short tap = normal press, hold = long-press; no separate down/up events",vibration:"Vibration",vibStrength:"Vibration strength",vibStrengthDesc:"Base duration in ms — higher is stronger",vibAvailable:"✓ API supported (press a key, then re-open to see result)",vibWorking:"✓ Vibration works",vibBlocked:"✗ System rejected vibration — check Settings → Touch vibration / DND",vibUnavailable:"✗ Vibration not supported (iOS Safari has no Vibration API)",close:"Close",editTitle:"Edit App",editName:"App name",editUpload:"Upload icon",editDelete:"Delete",editSave:"Save",editCancel:"Cancel",toastAdded:"✓ Added",toastRemoved:"✗ Removed",toastLaunching:"Launching",toastClearing:"Clearing…",toastCleared:"✓ Cleared",toastSent:"✓ Sent",toastSaved:"✓ Saved",toastConnecting:"Connecting…",toastConnected:"✓ Connected",toastFailed:"✗ Failed",toastForceReconnect:"Force reconnecting… check TV",toastApproveOnTv:"\uD83D\uDD10 Look at your TV screen",toastSentFail:"✗ Failed to send",toastLaunchFail:"✗ Failed to launch",titleTapLaunch:"Tap to launch · Long-press to remove",volUp:"Vol+",volDown:"Vol-",prev:"Prev",next:"Next",rewind:"Rewind",fastForward:"FF",playPause:"Play/Pause",mute:"Mute",up:"Up",down:"Down",left:"Left",right:"Right",ok:"OK"}};function M1(){return(navigator.language||navigator.userLanguage||"en").toLowerCase().startsWith("zh")?"zh":"en"}var t1=M1(),o=(h)=>s[t1][h]??s.en[h]??h;function c(h){return`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${h}</svg>`}var I={"chevron-up":c('<path d="m18 15-6-6-6 6" />'),"chevron-down":c('<path d="m6 9 6 6 6-6" />'),"chevron-left":c('<path d="m15 18-6-6 6-6" />'),"chevron-right":c('<path d="m9 18 6-6-6-6" />'),check:c('<path d="M20 6 9 17l-5-5" />'),circle:c('<circle cx="12" cy="12" r="10" />'),"corner-up-left":c(`<path d="M20 20v-7a4 4 0 0 0-4-4H4" />
  ...
  <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />`)};var n=(h,r=22)=>`<span class="lic">${I[h].replace("<svg",`<svg width="${r}" height="${r}"`)}</span>`,O=[],H=[],l,$=!1,i=!1,q="",W=document.getElementById("app"),L=null;function h1(){let h=location.protocol==="https:"?"wss":"ws";L=new WebSocket(`${h}://${location.host}/ws`),L.onopen=()=>{console.log("WS open"),F("connected"),t({favGet:!0})},L.onclose=()=>{L=null,F("disconnected"),setTimeout(h1,2000)},L.onmessage=(r)=>{let a=JSON.parse(r.data);if(a.ping)return;if(a.type==="status"){A1(a);return}if(a.type==="apps"){H=a.apps,G(H);return}if(a.type==="favorites"){O=a.favorites,o1();return}if(a.type==="icons"){f1(a.icons);return}if(a.type==="inputState"){i=a.editable,q=a.text||"",v1();return}if(a.error)D(`✗ ${a.error}`);else if(a.method==="yadb")D(o("toastSent"));else if(a.method==="yadb_clear")D(o("toastCleared"));else if(a.connected!==void 0)D(a.connected?o("toastConnected"):o("toastFailed"))}}function t(h){if(L?.readyState===WebSocket.OPEN)return L.send(JSON.stringify(h)),!0;return!1}function v1(){let h=document.getElementById("btnText");if(!h)return;let r=h.querySelector(".tv-input-dot");if(i){if(h.classList.add("tv-input-active"),!r){let a=document.createElement("span");a.className="tv-input-dot",h.appendChild(a)}}else h.classList.remove("tv-input-active"),r?.remove()}async function f1(h){let r=!1;for(let[a,u]of Object.entries(h))try{let M=atob(u),f=new Uint8Array(M.length);for(let A=0;A<M.length;A++)f[A]=M.charCodeAt(A);await R(a,new Blob([f],{type:"image/png"})),x.delete(a),r=!0}catch{}if(r)o1(),G(H)}function F(h){let r=document.getElementById("statusDot"),a=document.getElementById("statusLabel"),u=document.getElementById("authHint");switch(h){case"connected":r.className="status-dot on",a.textContent=o("statusConnected"),u.classList.add("hidden"),j(!0),$=!0;break;case"disconnected":r.className="status-dot off",a.textContent=L?o("statusDisconnected"):o("statusReconnecting"),u.classList.add("hidden"),j(!1),$=!1;break;case"auth":r.className="status-dot auth",a.textContent=o("statusAuth"),u.classList.remove("hidden"),j(!1),$=!1;break;case"checking":r.className="status-dot off",a.textContent=o("statusChecking"),u.classList.add("hidden"),j(!1),$=!1;break}}function A1(h){switch(h.adbState){case"connected":F("connected");break;case"auth_required":F("auth");break;case"disconnected":case"no_device":F("disconnected");break}}function j(h){W.querySelectorAll(".dpad-btn:not(.empty), .action-btn, .media-btn, .btn-kbd, .app-chip:not(.add-chip)").forEach((r)=>{r.style.opacity=h?"":"0.4",r.style.pointerEvents=h?"":"none"})}function V1(){F("checking"),t({connect:!0})}function p1(){F("checking"),D(o("toastForceReconnect")),p([30,30,30]),t({forceReconnect:!0})}function D(h){let r=document.getElementById("toast");r.textContent=h,r.classList.add("show"),clearTimeout(l),l=setTimeout(()=>r.classList.remove("show"),2000)}function d(h){return h.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var g=!0,_=null,B=null,N=null,x1=new Set(["up","down","left","right"]),y=500,D1=50,L1=[25,50,100,125],v={menuFix:!1,dpadRepeat:!0,simLongPress:!1,vibStrength:25};function d1(){try{let h=localStorage.getItem("tv-remote-settings");if(h)v={...v,...JSON.parse(h)}}catch{}}function Y(){try{localStorage.setItem("tv-remote-settings",JSON.stringify(v))}catch{}}function m(){let h=document.getElementById("menuFixToggle"),r=document.getElementById("dpadRepeatToggle"),a=document.getElementById("simLongPressToggle");if(h)h.checked=v.menuFix;if(r)r.checked=v.dpadRepeat;if(a)a.checked=v.simLongPress;g=v.dpadRepeat,document.querySelectorAll(".vib-level-btn").forEach((u)=>{u.classList.toggle("active",Number(u.dataset.level)===v.vibStrength)})}function F1(h){v.menuFix=h,Y(),p(28)}function z1(h){v.dpadRepeat=h,g=h,Y(),p(28)}function H1(h){v.simLongPress=h,Y(),p(28)}function N1(h){v.vibStrength=h,Y(),m(),p(h)}function w1(){m();let h=document.getElementById("vibStatusText");if(!J)h.textContent=o("vibUnavailable");else if(K===!1)h.textContent=o("vibBlocked");else if(K===!0)h.textContent=o("vibWorking");else h.textContent=o("vibAvailable");document.getElementById("settingsModal").classList.remove("hidden")}function E(){document.getElementById("settingsModal").classList.add("hidden")}var J=typeof navigator.vibrate==="function",K=null;function p(h){let r=v.vibStrength/25,a=Array.isArray(h)?h.map((u)=>Math.round(u*r)):Math.round(h*r);try{if(typeof navigator.vibrate==="function")K=navigator.vibrate(a),J=!0;else J=!1}catch{J=!1}}var S=null,U=!1,X=null;function C1(h){let r=document.querySelector(`[data-key="${h}"]`);if(r)r.classList.add("pressed");if(p(28),v.simLongPress){S=h,U=!1,X=setTimeout(()=>{if(U=!0,p(20),v.menuFix&&h==="menu")t({keyLong:h});else t({key:h})},y);return}if(v.menuFix&&h==="menu"){t({keyLong:h});return}if(t({keydown:h}),g&&x1.has(h))N=h,B=setTimeout(()=>{if(N===h)_=setInterval(()=>{if(N===h)p(14),t({keydown:h})},D1)},y)}function T(h){let r=document.querySelector(`[data-key="${h}"]`);if(r)r.classList.remove("pressed");if(v.simLongPress){if(X)clearTimeout(X),X=null;if(S===h&&!U)if(v.menuFix&&h==="menu")t({keyLong:h});else t({key:h});S=null;return}if(v.menuFix&&h==="menu")return;if(N===h)clearTimeout(B),clearInterval(_),B=_=null,N=null,p(20);t({keyup:h})}function Q1(){document.getElementById("textModal").classList.remove("hidden");let h=document.getElementById("textInput");if(i&&q)h.value=q;else h.value="";a1(),setTimeout(()=>{h.focus(),h.select(),setTimeout(()=>{document.getElementById("textModal").scrollIntoView({block:"start"})},300)},100)}function a1(){let h=document.getElementById("textInput"),r=document.getElementById("btnAction");if(h.value.trim().length>0)r.innerHTML=`${n("send",18)} ${o("send")}`,r.className="btn-primary";else r.innerHTML=`${n("trash-2",18)} ${o("clear")}`,r.className="btn-cancel"}function e(){if(document.getElementById("textInput").value.trim().length>0)$1();else j1()}function r1(){document.getElementById("textModal").classList.add("hidden"),document.getElementById("textInput").value=""}function $1(){let r=document.getElementById("textInput").value.trim();if(!r)return;p([30,50,30]),t({text:r}),r1()}function j1(){p([25,40,25]),t({clear:!0})}async function J1(h,r){t({favAdd:{pkg:h,label:r}}),D(`${o("toastAdded")}: ${r}`),u1()}function X1(h){t({favDel:h}),D(o("toastRemoved"))}var w="",C=null;async function k(h,r){w=h,C=null,document.getElementById("editName").value=r,document.getElementById("editFile").value="";let a=document.getElementById("editIconPreview"),u=await P(`custom_${h}`);if(u)a.src=URL.createObjectURL(u);else if(x.get(h))a.src=x.get(h);else try{let M=await fetch(`/icons/apps/${encodeURIComponent(h)}.png`);if(M.ok){let f=await M.blob();await R(h,f);let A=URL.createObjectURL(f);x.set(h,A),a.src=A}}catch{}a.classList.remove("hidden"),document.getElementById("editModal").classList.remove("hidden")}function Z(){document.getElementById("editModal").classList.add("hidden")}function Z1(){let h=document.getElementById("editFile").files?.[0];if(!h)return;C=h,document.getElementById("editIconPreview").src=URL.createObjectURL(h)}async function b(){let h=document.getElementById("editName").value.trim();if(!h)return;if(C)await R(`custom_${w}`,C),x.set(`custom_${w}`,URL.createObjectURL(C));t({favUpdate:{pkg:w,label:h}}),D(o("toastSaved")),Z()}function Y1(){t({favDel:w}),D(o("toastRemoved")),Z()}function G1(h,r){t({launch:h}),D(`${o("toastLaunching")}: ${r}`)}function o1(){let h=document.getElementById("favApps"),r=`<button class="app-chip add-chip" id="addAppBtn" title="${o("addApp")}">${n("plus",26)}</button>`;if(!O.length)h.innerHTML=r;else h.innerHTML=O.map((a)=>`
      ...
      </button>`).join("")+r;document.getElementById("addAppBtn")?.addEventListener("click",R1),h.querySelectorAll(".app-chip:not(.add-chip)").forEach((a)=>{let u=a.dataset.pkg,M=a.querySelector(".app-name")?.textContent||u,f=a.querySelector("img.app-img");if(f)c1(f,u);a.addEventListener("click",()=>{if(!V)G1(u,M)}),a.addEventListener("contextmenu",(z)=>{z.preventDefault(),k(u,M)});let A,V=!1;a.addEventListener("pointerdown",()=>{V=!1,A=setTimeout(()=>{V=!0,k(u,M)},600)}),a.addEventListener("pointerup",()=>{clearTimeout(A)}),a.addEventListener("pointerleave",()=>{clearTimeout(A)}),a.querySelector(".delete-badge")?.addEventListener("click",(z)=>{z.stopPropagation(),X1(u)})})}async function R1(){if(document.getElementById("pickerModal").classList.remove("hidden"),document.getElementById("appSpinner").style.display="block",document.getElementById("appSearch").value="",!H.length)t({appList:!0});else G(H)}function u1(){document.getElementById("pickerModal").classList.add("hidden")}function T1(){let h=document.getElementById("appSearch").value.toLowerCase();G(H.filter((r)=>r.label.toLowerCase().includes(h)||r.pkg.toLowerCase().includes(h)))}function G(h){let r=document.getElementById("appPickerList");if(document.getElementById("appSpinner").style.display="none",!h.length){r.innerHTML=`<div style="padding:20px;text-align:center;color:#999">${o("noAppsFound")}</div>`;return}r.innerHTML=h.map((a)=>`
    ...
    </button>`).join(""),r.querySelectorAll(".picker-item").forEach((a)=>{a.addEventListener("click",()=>J1(a.dataset.pkg,a.dataset.label));let u=a.querySelector("img.app-img");if(u)c1(u,u.dataset.pkg)})}var O1="tv-remote-icons",Q="icons",x=new Map;function n1(){return new Promise((h,r)=>{let a=indexedDB.open(O1,1);a.onupgradeneeded=()=>a.result.createObjectStore(Q,{keyPath:"pkg"}),a.onsuccess=()=>h(a.result),a.onerror=()=>r(a.error)})}function P(h){return new Promise(async(r)=>{try{let M=(await n1()).transaction(Q,"readonly").objectStore(Q).get(h);M.onsuccess=()=>r(M.result?.blob??null),M.onerror=()=>r(null)}catch{r(null)}})}function R(h,r){return new Promise(async(a)=>{try{let M=(await n1()).transaction(Q,"readwrite");M.objectStore(Q).put({pkg:h,blob:r}),M.oncomplete=()=>a(),M.onerror=()=>a()}catch{a()}})}async function c1(h,r){let a=()=>{h.classList.add("hidden"),h.nextElementSibling?.classList.remove("hidden")},u=(V)=>{h.src=V,h.classList.remove("hidden"),h.nextElementSibling?.classList.add("hidden")},M=await P(`custom_${r}`);if(M){let V=x.get(`custom_${r}`);if(!V)V=URL.createObjectURL(M),x.set(`custom_${r}`,V);u(V);return}let f=x.get(r);if(f){u(f);return}let A=await P(r);if(A){f=URL.createObjectURL(A),x.set(r,f),u(f);return}try{let V=await fetch(`/icons/apps/${encodeURIComponent(r)}.png`);if(V.ok){let z=await V.blob();await R(r,z),f=URL.createObjectURL(z),x.set(r,f),u(f);return}}catch{}a()}function q1(){W.innerHTML=`
