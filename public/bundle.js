var I={zh:{appTitle:"\uD83D\uDCFA TV Remote",statusConnected:"已连接",statusDisconnected:"未连接",statusReconnecting:"重连中…",statusChecking:"连接中…",statusAuth:"等待授权",statusError:"错误",statusNoDevice:"未设置设备",statusTapReconnect:"点击重连",statusTapRetry:"点击重试 — 在 TV 上确认",statusTapCheck:"点击检查",authHint1:"⚠️ 等待 TV 授权。请在电视上确认调试授权弹窗。",authHint2:"如未弹出，请在 TV 设置中：撤销 USB 调试授权，然后关闭再重开 ADB 调试。",authForceBtn:"强制重新认证",authApproving:"正在 TV 上确认…",actionBack:"返回",actionHome:"主页",actionMenu:"菜单",quickLaunch:"快捷启动应用",addApp:"添加应用",textInput:"文本输入",textModalTitle:"在 TV 上输入",textPlaceholder:"输入要发送的文本…",clear:"清空",cancel:"取消",send:"发送",pickerTitle:"选择应用",searchPlaceholder:"\uD83D\uDD0D 搜索应用…",noAppsFound:"未找到应用",settingsTitle:"设置",settingMenuFix:"菜单键修复",settingMenuFixDesc:"若菜单键单击不灵敏（需要双击）可开启",settingDpadRepeat:"方向键长按重复",settingDpadRepeatDesc:"长按上下左右时自动连续触发",settingSimLongPress:"模拟长按（操作更稳定）",settingSimLongPressDesc:"短按=普通按下，长按=长按事件；不发送分离的按下/抬起",vibration:"振动反馈",vibStrength:"振动强度",vibStrengthDesc:"基础时长（毫秒），档位越高越强",vibAvailable:"✓ 支持振动（按一次按键后刷新查看结果）",vibWorking:"✓ 振动正常工作",vibBlocked:"✗ 系统拒绝了振动 — 请检查系统设置 → 触摸振动/免打扰",vibUnavailable:"✗ 此设备/浏览器不支持振动（iOS Safari 不支持）",close:"关闭",editTitle:"编辑应用",editName:"应用名称",editUpload:"上传图标",editDelete:"删除",editSave:"保存",editCancel:"取消",toastAdded:"已添加",toastRemoved:"已移除",toastLaunching:"启动中",toastClearing:"清空中…",toastCleared:"已清空",toastSent:"已发送",toastSaved:"已保存",toastConnecting:"连接中…",toastConnected:"✓ 已连接",toastFailed:"✗ 失败",toastForceReconnect:"强制重连中… 请查看 TV",toastApproveOnTv:"\uD83D\uDD10 请查看 TV 屏幕",toastSentFail:"✗ 发送失败",toastLaunchFail:"✗ 启动失败",titleTapLaunch:"点击启动 · 长按移除",volUp:"音量+",volDown:"音量-",prev:"上一个",next:"下一个",rewind:"快退",fastForward:"快进",playPause:"播放/暂停",mute:"静音",up:"上",down:"下",left:"左",right:"右",ok:"确定"},en:{appTitle:"\uD83D\uDCFA TV Remote",statusConnected:"Connected",statusDisconnected:"Disconnected",statusReconnecting:"Reconnecting…",statusChecking:"Connecting…",statusAuth:"Waiting for approval",statusError:"Error",statusNoDevice:"No device",statusTapReconnect:"Tap to reconnect",statusTapRetry:"Tap to retry — approve on TV",statusTapCheck:"Tap to check",authHint1:"⚠️ Waiting for TV approval. Check the debug authorization dialog on your TV.",authHint2:"If it doesn't appear: revoke USB debugging authorizations, then toggle ADB debugging off/on.",authForceBtn:"Force Re-authenticate",authApproving:"Approve on TV…",actionBack:"Back",actionHome:"Home",actionMenu:"Menu",quickLaunch:"Quick Launch",addApp:"Add App",textInput:"Text Input",textModalTitle:"Type on TV",textPlaceholder:"Enter text to send…",clear:"Clear",cancel:"Cancel",send:"Send",pickerTitle:"Select App",searchPlaceholder:"\uD83D\uDD0D Search apps…",noAppsFound:"No apps found",settingsTitle:"Settings",settingMenuFix:"Menu Key Fix",settingMenuFixDesc:"Enable if the menu key needs a double-tap to respond",settingDpadRepeat:"D-pad Key Repeat",settingDpadRepeatDesc:"Auto-repeat when holding up/down/left/right",settingSimLongPress:"Simulated Long-press (more stable)",settingSimLongPressDesc:"Short tap = normal press, hold = long-press; no separate down/up events",vibration:"Vibration",vibStrength:"Vibration strength",vibStrengthDesc:"Base duration in ms — higher is stronger",vibAvailable:"✓ API supported (press a key, then re-open to see result)",vibWorking:"✓ Vibration works",vibBlocked:"✗ System rejected vibration — check Settings → Touch vibration / DND",vibUnavailable:"✗ Vibration not supported (iOS Safari has no Vibration API)",close:"Close",editTitle:"Edit App",editName:"App name",editUpload:"Upload icon",editDelete:"Delete",editSave:"Save",editCancel:"Cancel",toastAdded:"✓ Added",toastRemoved:"✗ Removed",toastLaunching:"Launching",toastClearing:"Clearing…",toastCleared:"✓ Cleared",toastSent:"✓ Sent",toastSaved:"✓ Saved",toastConnecting:"Connecting…",toastConnected:"✓ Connected",toastFailed:"✗ Failed",toastForceReconnect:"Force reconnecting… check TV",toastApproveOnTv:"\uD83D\uDD10 Look at your TV screen",toastSentFail:"✗ Failed to send",toastLaunchFail:"✗ Failed to launch",titleTapLaunch:"Tap to launch · Long-press to remove",volUp:"Vol+",volDown:"Vol-",prev:"Prev",next:"Next",rewind:"Rewind",fastForward:"FF",playPause:"Play/Pause",mute:"Mute",up:"Up",down:"Down",left:"Left",right:"Right",ok:"OK"}};function c1(){return(navigator.language||navigator.userLanguage||"en").toLowerCase().startsWith("zh")?"zh":"en"}var M1=c1(),o=(h)=>I[M1][h]??I.en[h]??h;function t(h){return`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${h}</svg>`}var l={"chevron-up":t('<path d="m18 15-6-6-6 6" />'),"chevron-down":t('<path d="m6 9 6 6 6-6" />'),"chevron-left":t('<path d="m15 18-6-6 6-6" />'),"chevron-right":t('<path d="m9 18 6-6-6-6" />'),check:t('<path d="M20 6 9 17l-5-5" />'),circle:t('<circle cx="12" cy="12" r="10" />'),"corner-up-left":t(`<path d="M20 20v-7a4 4 0 0 0-4-4H4" />
  ...
  <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />`)};var n=(h,r=22)=>`<span class="lic">${l[h].replace("<svg",`<svg width="${r}" height="${r}"`)}</span>`,O=[],H=[],E,$=!1,g=!1,q="",W=document.getElementById("app"),d=null;function h1(){let h=location.protocol==="https:"?"wss":"ws";d=new WebSocket(`${h}://${location.host}/ws`),d.onopen=()=>{console.log("WS open"),z("connected"),M({favGet:!0})},d.onclose=()=>{d=null,z("disconnected"),setTimeout(h1,2000)},d.onmessage=(r)=>{let a=JSON.parse(r.data);if(a.ping)return;if(a.type==="status"){A1(a);return}if(a.type==="apps"){H=a.apps,R(H);return}if(a.type==="favorites"){O=a.favorites,o1();return}if(a.type==="icons"){f1(a.icons);return}if(a.type==="inputState"){g=a.editable,q=a.text||"",v1();return}if(a.error)L(`✗ ${a.error}`);else if(a.method==="yadb")L(o("toastSent"));else if(a.method==="yadb_clear")L(o("toastCleared"));else if(a.connected!==void 0)L(a.connected?o("toastConnected"):o("toastFailed"))}}function M(h){if(d?.readyState===WebSocket.OPEN)return d.send(JSON.stringify(h)),!0;return!1}function v1(){let h=document.getElementById("btnText");if(!h)return;let r=h.querySelector(".tv-input-dot");if(g){if(h.classList.add("tv-input-active"),!r){let a=document.createElement("span");a.className="tv-input-dot",h.appendChild(a)}}else h.classList.remove("tv-input-active"),r?.remove()}async function f1(h){let r=!1;for(let[a,u]of Object.entries(h))try{let c=atob(u),f=new Uint8Array(c.length);for(let A=0;A<c.length;A++)f[A]=c.charCodeAt(A);await G(a,new Blob([f],{type:"image/png"})),x.delete(a),r=!0}catch{}if(r)o1(),R(H)}function z(h){let r=document.getElementById("statusDot"),a=document.getElementById("statusLabel"),u=document.getElementById("authHint");switch(h){case"connected":r.className="status-dot on",a.textContent=o("statusConnected"),u.classList.add("hidden"),j(!0),$=!0;break;case"disconnected":r.className="status-dot off",a.textContent=d?o("statusDisconnected"):o("statusReconnecting"),u.classList.add("hidden"),j(!1),$=!1;break;case"auth":r.className="status-dot auth",a.textContent=o("statusAuth"),u.classList.remove("hidden"),j(!1),$=!1;break;case"checking":r.className="status-dot off",a.textContent=o("statusChecking"),u.classList.add("hidden"),j(!1),$=!1;break}}function A1(h){switch(h.adbState){case"connected":z("connected");break;case"auth_required":z("auth");break;case"disconnected":case"no_device":z("disconnected");break}}function j(h){W.querySelectorAll(".dpad-btn:not(.empty), .action-btn, .media-btn, .btn-kbd, .app-chip:not(.add-chip)").forEach((r)=>{r.style.opacity=h?"":"0.4",r.style.pointerEvents=h?"":"none"})}function V1(){z("checking"),M({connect:!0})}function p1(){z("checking"),L(o("toastForceReconnect")),p([30,30,30]),M({forceReconnect:!0})}function L(h){let r=document.getElementById("toast");r.textContent=h,r.classList.add("show"),clearTimeout(E),E=setTimeout(()=>r.classList.remove("show"),2000)}function F(h){return h.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var m=!0,B=null,K=null,N=null,U=new Set(["up","down","left","right"]),x1=500,L1=50,d1=150,F1=[25,50,100,125],v={menuFix:!1,dpadRepeat:!0,simLongPress:!1,vibStrength:25};function z1(){try{let h=localStorage.getItem("tv-remote-settings");if(h)v={...v,...JSON.parse(h)}}catch{}}function Z(){try{localStorage.setItem("tv-remote-settings",JSON.stringify(v))}catch{}}function s(){let h=document.getElementById("menuFixToggle"),r=document.getElementById("dpadRepeatToggle"),a=document.getElementById("simLongPressToggle");if(h)h.checked=v.menuFix;if(r)r.checked=v.dpadRepeat;if(a)a.checked=v.simLongPress;m=v.dpadRepeat,document.querySelectorAll(".vib-level-btn").forEach((u)=>{u.classList.toggle("active",Number(u.dataset.level)===v.vibStrength)})}function D1(h){v.menuFix=h,Z(),p(28)}function H1(h){v.dpadRepeat=h,m=h,Z(),p(28)}function N1(h){v.simLongPress=h,Z(),p(28)}function w1(h){v.vibStrength=h,Z(),s(),p(h)}function C1(){s();let h=document.getElementById("vibStatusText");if(!J)h.textContent=o("vibUnavailable");else if(_===!1)h.textContent=o("vibBlocked");else if(_===!0)h.textContent=o("vibWorking");else h.textContent=o("vibAvailable");document.getElementById("settingsModal").classList.remove("hidden")}function y(){document.getElementById("settingsModal").classList.add("hidden")}var J=typeof navigator.vibrate==="function",_=null;function p(h){let r=v.vibStrength/25,a=Array.isArray(h)?h.map((u)=>Math.round(u*r)):Math.round(h*r);try{if(typeof navigator.vibrate==="function")_=navigator.vibrate(a),J=!0;else J=!1}catch{J=!1}}var i=null,P=!1,T=null;function Q1(h){let r=document.querySelector(`[data-key="${h}"]`);if(r)r.classList.add("pressed");if(p(28),v.simLongPress&&!U.has(h)){i=h,P=!1,T=setTimeout(()=>{P=!0,p(20),M({keydown:h})},d1);return}if(v.menuFix&&h==="menu"){M({keyLong:h});return}if(M({keydown:h}),m&&U.has(h))N=h,K=setTimeout(()=>{if(N===h)B=setInterval(()=>{if(N===h)p(14),M({keydown:h})},L1)},x1)}function Y(h){let r=document.querySelector(`[data-key="${h}"]`);if(r)r.classList.remove("pressed");if(v.simLongPress&&!U.has(h)){if(T)clearTimeout(T),T=null;if(i===h)if(P)M({keyup:h});else if(v.menuFix&&h==="menu")M({keyLong:h});else M({key:h});i=null;return}if(v.menuFix&&h==="menu")return;if(N===h)clearTimeout(K),clearInterval(B),K=B=null,N=null,p(20);M({keyup:h})}function $1(){document.getElementById("textModal").classList.remove("hidden");let h=document.getElementById("textInput");if(g&&q)h.value=q;else h.value="";a1(),setTimeout(()=>{h.focus(),h.select(),setTimeout(()=>{document.getElementById("textModal").scrollIntoView({block:"start"})},300)},100)}function a1(){let h=document.getElementById("textInput"),r=document.getElementById("btnAction");if(h.value.trim().length>0)r.innerHTML=`${n("send",18)} ${o("send")}`,r.className="btn-primary";else r.innerHTML=`${n("trash-2",18)} ${o("clear")}`,r.className="btn-cancel"}function e(){if(document.getElementById("textInput").value.trim().length>0)j1();else J1()}function r1(){document.getElementById("textModal").classList.add("hidden"),document.getElementById("textInput").value=""}function j1(){let r=document.getElementById("textInput").value.trim();if(!r)return;p([30,50,30]),M({text:r}),r1()}function J1(){p([25,40,25]),M({clear:!0})}async function T1(h,r){M({favAdd:{pkg:h,label:r}}),L(`${o("toastAdded")}: ${r}`),u1()}function X1(h){M({favDel:h}),L(o("toastRemoved"))}var w="",C=null;async function k(h,r){w=h,C=null,document.getElementById("editName").value=r,document.getElementById("editFile").value="";let a=document.getElementById("editIconPreview"),u=await S(`custom_${h}`);if(u)a.src=URL.createObjectURL(u);else if(x.get(h))a.src=x.get(h);else try{let c=await fetch(`/icons/apps/${encodeURIComponent(h)}.png`);if(c.ok){let f=await c.blob();await G(h,f);let A=URL.createObjectURL(f);x.set(h,A),a.src=A}}catch{}a.classList.remove("hidden"),document.getElementById("editModal").classList.remove("hidden")}function X(){document.getElementById("editModal").classList.add("hidden")}function Z1(){let h=document.getElementById("editFile").files?.[0];if(!h)return;C=h,document.getElementById("editIconPreview").src=URL.createObjectURL(h)}async function b(){let h=document.getElementById("editName").value.trim();if(!h)return;if(C)await G(`custom_${w}`,C),x.set(`custom_${w}`,URL.createObjectURL(C));M({favUpdate:{pkg:w,label:h}}),L(o("toastSaved")),X()}function R1(){M({favDel:w}),L(o("toastRemoved")),X()}function G1(h,r){M({launch:h}),L(`${o("toastLaunching")}: ${r}`)}function o1(){let h=document.getElementById("favApps"),r=`<button class="app-chip add-chip" id="addAppBtn" title="${o("addApp")}">${n("plus",26)}</button>`;if(!O.length)h.innerHTML=r;else h.innerHTML=O.map((a)=>`
      <button class="app-chip" data-pkg="${F(a.pkg)}" title="${o("titleTapLaunch")}">
        <span class="app-emoji"><img class="app-img" data-pkg="${F(a.pkg)}" alt="" loading="lazy"><span class="app-fallback">${n("app-window",22)}</span></span>
        <span class="app-name">${F(a.label)}</span>
        <span class="delete-badge">${n("x",12)}</span>
      </button>`).join("")+r;document.getElementById("addAppBtn")?.addEventListener("click",Y1),h.querySelectorAll(".app-chip:not(.add-chip)").forEach((a)=>{let u=a.dataset.pkg,c=a.querySelector(".app-name")?.textContent||u,f=a.querySelector("img.app-img");if(f)t1(f,u);a.addEventListener("click",()=>{if(!V)G1(u,c)}),a.addEventListener("contextmenu",(D)=>{D.preventDefault(),k(u,c)});let A,V=!1;a.addEventListener("pointerdown",()=>{V=!1,A=setTimeout(()=>{V=!0,k(u,c)},600)}),a.addEventListener("pointerup",()=>{clearTimeout(A)}),a.addEventListener("pointerleave",()=>{clearTimeout(A)}),a.querySelector(".delete-badge")?.addEventListener("click",(D)=>{D.stopPropagation(),X1(u)})})}async function Y1(){if(document.getElementById("pickerModal").classList.remove("hidden"),document.getElementById("appSpinner").style.display="block",document.getElementById("appSearch").value="",!H.length)M({appList:!0});else R(H)}function u1(){document.getElementById("pickerModal").classList.add("hidden")}function O1(){let h=document.getElementById("appSearch").value.toLowerCase();R(H.filter((r)=>r.label.toLowerCase().includes(h)||r.pkg.toLowerCase().includes(h)))}function R(h){let r=document.getElementById("appPickerList");if(document.getElementById("appSpinner").style.display="none",!h.length){r.innerHTML=`<div style="padding:20px;text-align:center;color:#999">${o("noAppsFound")}</div>`;return}r.innerHTML=h.map((a)=>`
    <button class="picker-item" data-pkg="${F(a.pkg)}" data-label="${F(a.label)}">
      <span class="picker-ic"><img class="app-img" data-pkg="${F(a.pkg)}" alt="" loading="lazy"><span class="app-fallback">${n("app-window",22)}</span></span>
      <div><div>${F(a.label)}</div><div class="pkg-sub">${F(a.pkg)}</div></div>
    </button>`).join(""),r.querySelectorAll(".picker-item").forEach((a)=>{a.addEventListener("click",()=>T1(a.dataset.pkg,a.dataset.label));let u=a.querySelector("img.app-img");if(u)t1(u,u.dataset.pkg)})}var q1="tv-remote-icons",Q="icons",x=new Map;function n1(){return new Promise((h,r)=>{let a=indexedDB.open(q1,1);a.onupgradeneeded=()=>a.result.createObjectStore(Q,{keyPath:"pkg"}),a.onsuccess=()=>h(a.result),a.onerror=()=>r(a.error)})}function S(h){return new Promise(async(r)=>{try{let c=(await n1()).transaction(Q,"readonly").objectStore(Q).get(h);c.onsuccess=()=>r(c.result?.blob??null),c.onerror=()=>r(null)}catch{r(null)}})}function G(h,r){return new Promise(async(a)=>{try{let c=(await n1()).transaction(Q,"readwrite");c.objectStore(Q).put({pkg:h,blob:r}),c.oncomplete=()=>a(),c.onerror=()=>a()}catch{a()}})}async function t1(h,r){let a=()=>{h.classList.add("hidden"),h.nextElementSibling?.classList.remove("hidden")},u=(V)=>{h.src=V,h.classList.remove("hidden"),h.nextElementSibling?.classList.add("hidden")},c=await S(`custom_${r}`);if(c){let V=x.get(`custom_${r}`);if(!V)V=URL.createObjectURL(c),x.set(`custom_${r}`,V);u(V);return}let f=x.get(r);if(f){u(f);return}let A=await S(r);if(A){f=URL.createObjectURL(A),x.set(r,f),u(f);return}try{let V=await fetch(`/icons/apps/${encodeURIComponent(r)}.png`);if(V.ok){let D=await V.blob();await G(r,D),f=URL.createObjectURL(D),x.set(r,f),u(f);return}}catch{}a()}function B1(){W.innerHTML=`
  ...
  `}function K1(){document.addEventListener("contextmenu",(h)=>h.preventDefault()),document.getElementById("statusArea")?.addEventListener("click",V1),document.getElementById("btnForceReconnect")?.addEventListener("click",p1),document.getElementById("btnSettings")?.addEventListener("click",C1),document.getElementById("btnCloseSettings")?.addEventListener("click",y),document.getElementById("menuFixToggle")?.addEventListener("change",(h)=>{D1(h.target.checked)}),document.getElementById("dpadRepeatToggle")?.addEventListener("change",(h)=>{H1(h.target.checked)}),document.getElementById("simLongPressToggle")?.addEventListener("change",(h)=>{N1(h.target.checked)}),document.querySelectorAll(".vib-level-btn").forEach((h)=>{h.addEventListener("click",()=>w1(Number(h.dataset.level)))}),document.getElementById("settingsModal")?.addEventListener("click",(h)=>{if(h.target===h.currentTarget)y()}),document.getElementById("btnDeleteApp")?.addEventListener("click",R1),document.getElementById("btnCancelEdit")?.addEventListener("click",X),document.getElementById("btnSaveEdit")?.addEventListener("click",b),document.getElementById("editFile")?.addEventListener("change",Z1),document.getElementById("editName")?.addEventListener("keydown",(h)=>{if(h.key==="Enter")h.preventDefault(),b()}),document.getElementById("editModal")?.addEventListener("click",(h)=>{if(h.target===h.currentTarget)X()}),W.querySelectorAll("[data-key]").forEach((h)=>{let r=h.dataset.key;h.addEventListener("pointerdown",(a)=>{a.preventDefault(),Q1(r)}),h.addEventListener("pointerup",(a)=>{a.preventDefault(),Y(r)}),h.addEventListener("pointerleave",()=>Y(r)),h.addEventListener("pointercancel",()=>Y(r))}),document.getElementById("btnText")?.addEventListener("click",$1),document.getElementById("btnCancelText")?.addEventListener("click",r1),document.getElementById("btnAction")?.addEventListener("click",e),document.getElementById("textInput")?.addEventListener("input",a1),document.getElementById("textInput")?.addEventListener("keydown",(h)=>{if(h.key==="Enter"&&!h.shiftKey)h.preventDefault(),e()}),document.getElementById("btnCancelPicker")?.addEventListener("click",u1),document.getElementById("appSearch")?.addEventListener("input",O1)}z1();B1();K1();s();h1();if(window.visualViewport)window.visualViewport.addEventListener("resize",()=>{let h=document.getElementById("textModal");if(h&&!h.classList.contains("hidden"))h.scrollIntoView({block:"start"})});if("serviceWorker"in navigator)navigator.serviceWorker.register("/sw.js",{updateViaCache:"none"}).then((h)=>{h.update().catch(()=>{})}).catch(()=>{});
